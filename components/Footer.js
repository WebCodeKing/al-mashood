...
const Footer = () => {
  return (
    <footer className="text-gray-400 bg-gray-900 body-font opacity-80">
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col text-center">
    <div className="flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <p className="hidden mt-2 text-sm text-gray-500">Air plant banjo lyft occupy retro adaptogen indego</p>
    </div>
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      ...
      {/* <div className="hidden lg:w-1/4 md:w-1/2 w-full px-4">
  ...
  <div className="bg-gray-800 bg-opacity-75">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row justify-center">
      <p className="text-gray-400 text-sm text-center sm:text-left">© 2025 Al-Mashood Munazzam Pvt Ltd. All Rights Reserved.
        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="hidden text-gray-500 ml-1" target="_blank">@knyttneve</a>
      </p>
      {/* <span className=" hidden inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
