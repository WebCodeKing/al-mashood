...
const hajj2024 = () => {
  return (
    ...
    {/* <div className='max-w-[85%] my-[110px] bg-opacity-[40%] mx-auto'>
        ...
        {/* </Swiper> */}
    {/* </div> */}
    <div className='flex flex-wrap justify-items-center mx-auto gap-8 w-[90%] md:w-[85%]'>
      <Link href="/SECP/2024/certifiacte-of-incorporation.pdf" className='mx-auto'>
    <div className="relative flex-col justify-items-center items-center max-w-3xl mx-auto p-8 border-t-4 border-indigo-500 shadow-2xl hover:shadow-3xl transition-shadow rounded-xl bg-gradient-to-r from-gray-50 to-white my-[100px] md:w-[31vw] hover:border-x hover:border-b cursor-pointer">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Incorporation Ceritificate</h2>
          </div>
          {/* Next.js Optimized Image */}
          {/* <div className="relative mb-4 md:w-[15vw]"> */}
          <div className="mb-4 md:w-[15vw]">
            <Image
              src="/SECP/2024/Certifiacte of Incorporation.png" // Replace with your image path
        ...
        <Link href="/SECP/2024/FORM-II (Al-mashood).pdf" className='mx-auto'>
    <div className="relative flex-col justify-items-center items-center max-w-3xl mx-auto p-8 border-t-4 border-indigo-500 shadow-2xl hover:shadow-3xl transition-shadow rounded-xl bg-gradient-to-r from-gray-50 to-white my-[100px] md:w-[31vw]  hover:border-x hover:border-b cursor-pointer">
          <div className="flex items-center gap-3 mb-4">
            {/* Document Icon */}
            <svg className="w-8 h-8 text-indigo-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Next.js Optimized Image */}
          {/* <div className="relative mb-4 md:w-[15vw] md:mt-[60px]"> */}
          <div className="mb-4 md:w-[15vw] md:mt-[60px]">
            <Image
        ...
        <Link href="/SECP/2024/Recongniation Letter.pdf" className='mx-auto'>
    <div className="relative flex-col justify-items-center items-center max-w-3xl mx-auto p-8 border-t-4 border-indigo-500 shadow-2xl hover:shadow-3xl transition-shadow rounded-xl bg-gradient-to-r from-gray-50 to-white my-[100px] md:w-[31vw] hover:border-x hover:border-b cursor-pointer">
          <div className="flex items-center gap-3 mb-4">
            {/* Document Icon */}
            <svg className="w-8 h-8 text-indigo-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
