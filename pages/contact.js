...
const Contact = () => {
  return (
    ...
    <div className='w-[95%] md:max-w-[85%] my-[110px] mx-auto'>
<section
   class="relative z-10 overflow-hidden bg-white dark:bg-dark py-20 lg:py-[120px] border rounded-xl shadow-lg px-[10px] md:px-[80px]"
   >
   <div class="container mx-auto">
            ...
            <div class="mb-12 max-w-[570px] lg:mb-0">
               ...
               <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                     ...
                     Office No.4, 1st Floor, AL-Rayan Plaza
      ...
      ></iframe>
            ...
            {/* <div
               class="relative p-8 bg-white border rounded-lg shadow-lg dark:bg-dark-2 sm:p-12"
               > */}
               {/* <form>
                  <div class="mb-6">
                     <input
                  ...
                  <div>
                     <button
                        type="submit"
                        className="bg-gray-700 w-full p-3 text-white transition border rounded border-primary bg-primary hover:bg-opacity-90"
                        >
                     Send Message
                     </button>
                  </div>
