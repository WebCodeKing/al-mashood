    ...
    documents: [
      {
        ...
        preview: '/legal-documents/2025/certifiacte-of-incorporation.png',
        href: '/legal-documents/2025/certifiacte-of-incorporation.pdf',
      },
      {
        title: 'Form II',
        description: 'Company statutory attachment and particulars for SECP record.',
        preview: '/legal-documents/2025/CTC OF INC. FORM-II_Page_1.jpg',
        href: '/legal-documents/2025/CTC OF INC. FORM-II.pdf',
      },
      {
        title: 'Form III',
        description: 'Company compliance and supporting information attachment for SECP reference.',
      ...
      },
      {
        ...
        preview: '/legal-documents/2025/form-7_page-0001.jpg',
        href: '/legal-documents/2025/form-7.pdf',
      },
      {
        title: 'Form 26',
        description: 'Company financial statement attachment for SECP review and regulatory reference.',
        preview: '/legal-documents/2025/form-26_page-0001.jpg',
        href: '/legal-documents/2025/form-26.pdf',
      },
      {
        title: 'Articles of Association',
        description: 'The foundational document outlining the company\'s purpose, structure, and rules.',
        preview: '/legal-documents/2025/aoa_page-0001.jpg',
        href: '/legal-documents/2025/aoa.pdf',
      },
      {
        ...
        preview: '/legal-documents/2025/moa_page-0001.jpg',
        href: '/legal-documents/2025/moa.pdf',
      },
    ],
  },
  {
    ...
    shortTitle: 'MORA',
    description: 'Ministry recognition, approval, and compliance attachments for Hajj 2025.',
    icon: Landmark,
    documents: [
      {
    ...
    documents: [
      {
        ...
        preview: '/legal-documents/2025/ntn-al-mashood-d061224_page-0001.jpg',
        href: '/legal-documents/2025/ntn-al-mashood-d061224.pdf',
      },
      // {
      //   title: 'NTN Verification',
      //   description: 'National Tax Number verification and supporting record attachment.',
      //   preview: '/legal-documents/2025/form-II.png',
      //   href: '/legal-documents/2025/form-II.pdf',
      // },
      // {
...
export default function Hajj2025LegalAttachments() {
  return (
    <>
      <Head>
        <title>SECP Hajj 2025 Legal Attachments | Al Mashood Munazzam</title>
        <meta
          name="description"
          content="MORA, Association, and HOAP legal attachments for Al Mashood Munazzam Pvt Ltd Hajj 2025."
        />
      </Head>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="max-w-3xl max-lg:text-center">
                ...
                <h1 className="bg-gradient-to-r from-[#ce9733] to-[#8a641f] bg-clip-text text-4xl font-bold leading-tight text-transparent md:text-5xl">
                  Hajj 2025 Official Legal Records
                </h1>
                <p className="mt-6 text-base leading-8 text-slate-600">
                  A refined public archive for official Hajj 2025 attachments, arranged by Ministry of Religious Affairs, Association documents, and HOAP records for clear review and direct document access.
                </p>
